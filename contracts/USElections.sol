...
contract USElections is Ownable {
    ...
    function submitStateResult(StateResult calldata result) public onlyOwner onlyActiveElection {
        ...
        require(result.votesBiden != result.votesTrump, "There can not be a tie!");
        require(!resultSubmitted[result.name], "This state result has been already submitted!");
